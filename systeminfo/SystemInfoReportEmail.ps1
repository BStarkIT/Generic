...
foreach ($computer in $computers) {
	...
	$TopProcesses = GET-WMIOBJECT win32_process -ComputerName $computer | Sort-Object WS -Descending | Select-Object ProcessName, Id, WS -First $ProccessNumToFetch | ConvertTo-Html -Fragment
