...
Start-Transcript -Path "\\scotcourts.local\data\CDiScripts\Scripts\Logs\Reinstate\$Date.txt" -append
$Version = "1.00"
...
function Activate {
    ...
    Rename-Item -Path "\\scotcourts.local\home\P\$Path" -NewName "$UserSamAccountName"
