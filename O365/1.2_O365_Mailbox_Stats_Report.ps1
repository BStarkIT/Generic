...
#>
  ...
  $obj | Add-Member -MemberType NoteProperty -Name extensionattribute1 -Value $aduser.extensionattribute1
  $obj | Add-Member -MemberType NoteProperty -Name extensionattribute2 -Value $aduser.extensionattribute2
  $obj | Add-Member -MemberType NoteProperty -Name extensionattribute3 -Value $aduser.extensionattribute3
  $obj | Add-Member -MemberType NoteProperty -Name extensionattribute4 -Value $aduser.extensionattribute4
  $obj | Add-Member -MemberType NoteProperty -Name extensionattribute5 -Value $aduser.extensionattribute5
  $obj | Add-Member -MemberType NoteProperty -Name extensionattribute6 -Value $aduser.extensionattribute6
...
$Dat = "O365_MailboxStats" + "_" + (Get-Date -Format "ddMMMyyyhhmmss") + ".csv"

$table | export-csv C:\scripts\o365\reports\$Dat -NoTypeInformation -Force
Write-Host " Results has been exported to C:\scripts\o365\reports\$Dat" -ForegroundColor green
