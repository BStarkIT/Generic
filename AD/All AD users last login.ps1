##
## exports a list of users with the date they last logged into the domain
##
Param
(
    [String]$OutCsvFilePath = "C:\Powershell\AllADUsersLastLogonTimeList.csv",
    [Int]$PageSize = 100
) 
$Filter = "(&(objectCategory=User))" 
##
## Ensure you have a folder in C:\ called "Powershell"        
##
##
