## This will reset the user's password, and force an AD sync across all your domain controllers.  
## Make sure you change the domain below.
##
param(
...
ForEach ($DC in $DomainControllers.Name) {
    ...
    Else {
        REPADMIN /syncall $DC "dc=ad,dc=Realise,dc=com" /d /e /q
    }
}
