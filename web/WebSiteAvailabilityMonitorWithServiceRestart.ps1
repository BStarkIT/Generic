...
.DESCRIPTION
Script that checks a Content String on a Web Site and Restarts a Specified Service if Not Matched. Includes HTML email functionality

.USAGE
Edit the variables below and test in your environment prior to setting up to run as a scheduled task
