...
$ArrayList.GetType()
$file = "\\scotcourts.local\data\IT\Civil Lab\00. Civil Lab Overall Delivery\Entitlement Attestation\ICMS\Completed Audits\Ayr.xlsx"
$group1 = "ICMS Ayr Judiciary"
$group2 = "ICMS Ayr Office Manager"
$group3 = "ICMS Ayr Admin Clerk"
$group4 = "ICMS Ayr Clerk of Court"
$group5 = "ICMS Ayr Adoption Admin Clerk"
