# Exchange 2013 Management v1.52
# Author        Brian Stark
# Date          14/04/2020
# Version       1.52
...
# 
#   Note        Line 101 has Shared Mailbox list with OLD path, New path not yet used.  Will need updateing once shared mailboxes moved.
#          
# Revisions     V1.52 14/04/2020 BS - addition of ActiveSync enable & device removal needed for Blackberry enablement & rebuild
