<#
.SYNOPSIS
This PowerShell script is to Change all email addresses within a single OU, to lowercase, without changing X400 or X500 values.
This is the Live version of the file.
.NOTES
