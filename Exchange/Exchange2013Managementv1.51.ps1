# Exchange 2013 Management v1.51
# Author        Brian Stark
# Date          06/04/2020
# Version       1.51
...
# 
#   Note        Line 100 has Shared Mailbox list with OLD path, New path not yet used.  Will need updateing once shared mailboxes moved.
#          
# Revisions     V1.51 06/04/2020 BS - updated registry paths for Win10 & office 2016, corrected user/Admin user SID error 
