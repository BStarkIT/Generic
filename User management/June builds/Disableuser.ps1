            ...
            if ($dialogResult -eq 'OK') {
                ...
                foreach ($SharedMailbox in $SharedMailboxes) {
                    ...
                    if ($null = $Shared) {
                        ...
                        Write-Host "Please remove $UserSamAccountName from $O365Shared via the O365 exchange control pannel"
                ...
                # Leaver processing completed   #
                    ...
                    [System.Windows.Forms.MessageBox]::Show("Disable User Accounts for Leavers for $($LeaverMBNameComboBox1.SelectedItem.ToString()) - Completed. Please advised 3rd line for O365 groups.", 'Disable User Accounts for Leavers.',
                    [System.Windows.Forms.MessageBoxButtons]::OK, [System.Windows.Forms.MessageBoxIcon]::Information)
                    $LeaverProcessForm.Close()
                Return LeaverProcess
                }
