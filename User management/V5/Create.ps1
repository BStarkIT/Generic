...
if ($UserName -notlike "*_a") {
    ...
    Function Build {
        ...
        if (($Track -eq "1") -or ($Track -eq "2") -or ($Track -eq "3")) {
            ...
            New-RemoteMailbox -SamAccountName $SAM -Archive
    ...
    Function Selection {
        ...
        $SelectionFormBox1.text = '1. The User Will be created with the following settings:'
    ...
    Function MainForm {
        ...
        if ($Result -eq 'OK') {
            ...
            if (($textBox1.Text -eq '') -or ($textBox2.Text -eq '') -or ($FirstName -match " ") -or ($LastName -match " ")) {
