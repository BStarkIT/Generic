...
# Revisions
#               V2.3  02/12/2021 BS - Cleanup        
#               V2.01 23/02/2021 BS - HMP calendars added
...
#####################################################################
Start-Transcript -Path "\\scotcourts.local\data\it\Enterprise Team\UserManagement\Add-New-User-With-Mailbox\Logs\Vicki.txt" -append
...
Function SharedCalendarManagementForm {
    ...
    $SharedMailBoxCalendarButton5.Text = 'Remove - Remove Calendar permissions for a User.'
    $SharedMailBoxCalendarButton5 = New-Object System.Windows.Forms.RadioButton
    $SharedMailBoxCalendarButton5.Location = '20,200'
    $SharedMailBoxCalendarButton5.size = '600,40'
    $SharedMailBoxCalendarButton5.Checked = $false
    $SharedMailBoxCalendarButton5.Text = 'Resource - Controls for MHP/Room calendars .'
    # Add an OK button.
    $OKButton = New-Object System.Windows.Forms.Button
    $OKButton.Location = '500,350'
    $OKButton.Size = '100,40' 
    ...
    # Add all the GroupBox controls on one line
    $SharedMailBoxCalendarBox.Controls.AddRange(@($SharedMailBoxCalendarButton1, $SharedMailBoxCalendarButton2, $SharedMailBoxCalendarButton3, $SharedMailBoxCalendarButton4, $SharedMailBoxCalendarButton5))
    # Assign the Accept and Cancel options in the form to the corresponding buttons
    ...
    if ($Result -eq 'OK') {
        ...
        elseif ($SharedMailBoxCalendarButton4.Checked) { RemoveCalendarPermAccessPermissionForm }
        elseif ($SharedMailBoxCalendarButton5.Checked = $true) { ResourceCalendarPermAccessPermissionForm }
    }
}
#########################################################################################################
...
Function MainForm {
    ...
    $Ex2013ManForm.Text = 'Exchange 2013 Management Main Form v2.00'
