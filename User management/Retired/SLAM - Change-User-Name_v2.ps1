...
#               v1.2 13/01/2020 - GK minor changes to null tests and removal of W10 OU from searchbase
...
if ($StartMessage -eq 'Cancel') { Exit } 
    ...
    Function ChangeOfName {
        ...
        if ($result -eq [System.Windows.Forms.DialogResult]::OK) {
            ...
            $poplabel = "Renaming the following users AD properties:`n`nDisplayname.`nLogOn name.`nP drive path."
            PopupForm
            #
