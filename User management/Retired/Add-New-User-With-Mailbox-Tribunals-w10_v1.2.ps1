...
#                A log is kept in \\scotcourts.local\data\it\Enterprise Team\UserManagement\Add-New-User-With-Mailbox\NewTribsUserLog.txt
...
# Changes        v1.2  GK change to take account of W10 OU. Improve readability.
...
#
Start-Transcript -Path "\\scotcourts.local\data\it\Enterprise Team\UserManagement\Add-New-User-With-Mailbox\Logs\NewTribsUserLog-w10.txt" -append
...
if ($StartMessage -eq 'Cancel') { 
    ...
    Function AddNewUser{
        ...
        $NewUserForm1.Text = "Add New Tribunal User Account with Exchange 2013 mailbox (W10) v$version"
