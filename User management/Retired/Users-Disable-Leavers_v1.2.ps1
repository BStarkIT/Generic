# Disable User Accounts for Leavers v1.1
# Author        John Mckay
# Date          11/09/2018
# Version       1.1 (2.02)
...
#
$version='1.2'
Start-Transcript -Path "\\saufs01\it\Enterprise Team\UserManagement\Users-Disable-Leavers\Logs\DisableLeaverslog-w10.txt" -append
...
if ($StartMessage -eq 'Cancel') {
    ...
    Function LeaverProcess {
        ...
        if ($dialogResult -eq 'OK') {
            ...
            If ($null -eq $MailboxCheck.EmailAddress -eq $null){
