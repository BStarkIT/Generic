# Delete User Accounts for Leavers v1.1
# Author        John Mckay
# Date          06/12/2018
# Version       1.2
...
#
# Changes       13/01/2020 GK - 1.2 minor changes to comments and readability
#               05/12/2019 GK - 1.1 (2.03) Replace references to \\scotcourts.local\data\users with \\scotcourts.local\home\p. Replace references to changed string with variable 
