...
#               v1.2  GK 8/1/20 updated all unc paths to use dsf format.
...
########################################################################
# Start logger
Start-Transcript -Path "\\saufs01\it\Enterprise Team\UserManagement\Add-New-User-With-Mailbox\Logs\NewSCTSUserlog-V2.txt" -Append
# Create Session with Exchange 2013
