...
# Useage        helpdesk staff run a shorcut to Disable User Accounts for Leavers v1.1.exe
#               
# Revisions     
#               V2.1  19/06/2020 BS - Update to current standards & include all current OU's
#               1.3   ??/04/2020 GK - changes to the location of the Disabled Leavers OU. Now located under the new OU heirarchy.                 
