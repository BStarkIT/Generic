...
Function SCTSForm {
    $OfficeList = Import-Csv "\\saufs01\CDiScripts\Scripts\Resources\Lists\Office.csv"
    $SecurityGroupsList = Import-Csv "\\saufs01\CDiScripts\Scripts\Resources\Lists\SecurityGroups.csv"
    $DescriptionList = Import-Csv "\\saufs01\CDiScripts\Scripts\Resources\Lists\description.csv"
...
Function Tribsform {
    $OfficeList = Import-Csv "\\saufs01\CDiScripts\Scripts\Resources\Lists\OfficeTribs.csv"
    $SecurityGroupsList = Import-Csv "\\saufs01\CDiScripts\Scripts\Resources\Lists\SecurityGroupsTribs.csv"
    $DescriptionList = Import-Csv "\\saufs01\CDiScripts\Scripts\Resources\Lists\DescriptionTribs.csv"
    $Distributionlists = Get-DistributionGroup | Select-Object Name | Select-Object -ExpandProperty Name
    [void] [System.Reflection.Assembly]::LoadWithPartialName('System.Windows.Forms')
    [void] [System.Reflection.Assembly]::LoadWithPartialName('System.Drawing') 
...
Function Judform {
    ...
    $OfficeList = Import-Csv "\\saufs01\CDiScripts\Scripts\Resources\Lists\JudicialUsers\officeJud.csv"
    $SecurityGroupsList = Import-Csv "\\saufs01\CDiScripts\Scripts\Resources\Lists\SecurityGroups.csv"
    $DescriptionList = Import-Csv "\\saufs01\CDiScripts\Scripts\Resources\Lists\JudicialUsers\descriptionJud.csv"
    $Distributionlists = Import-Csv "\\saufs01\CDiScripts\Scripts\Resources\Lists\JudicialUsers\distributionJud.csv"
    [void] [System.Reflection.Assembly]::LoadWithPartialName('System.Windows.Forms')
    [void] [System.Reflection.Assembly]::LoadWithPartialName('System.Drawing') 
...
Function MainForm {
    ...
    $JudFirstName = Import-Csv "\\saufs01\CDiScripts\Scripts\Resources\Lists\JudicialUsers\FirstNameJud.csv"
