...
$Users14 = Get-aduser -Filter * -searchbase 'OU=Contractors,OU=External Users,OU=UserAccounts,OU=COURTS,DC=scotcourts,DC=local' -Properties DisplayName| Select-Object Displayname | select-Object -ExpandProperty DisplayName
$UserNameList = $Users1 + $Users2 + $Users3 + $Users4 + $Users5 + $Users6 + $Users7 + $Users8 + $Users9 + $Users10 + $Users11 + $Users12 + $Users13 + $Users14
#  Show Start Message:   #
